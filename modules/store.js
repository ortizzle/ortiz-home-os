...
const DB_VERSION = 8; // v2: 'agenda'; v3: 'plan'; v4: 'meals'+'suggLog'; v5: 'briefs'+'pins'+'reviews'; v7: 'meetingState'; v8: 'memory'
...
export const STORES = [
  ...
  'memory', // Claudia's memory: lean typed facts, fed to every prompt (see hmcontext.js)
  'tombstones',
];
